...
**Status:** 🟠 In progress (Phase 2A v0.1 + v0.2 SHIPPED 2026-04-25 / 2026-04-26; v0.3 = Strategy/Setup/Rule/MarketCondition + Concept dedup + prompt-iteration backlog from v0.2 hand-review, not yet started)
